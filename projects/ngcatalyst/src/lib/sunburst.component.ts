import { Component, Input, OnChanges, SimpleChanges, AfterViewInit, AfterViewChecked } from '@angular/core';
...
export class SunburstComponent implements OnChanges, AfterViewInit, AfterViewChecked {
